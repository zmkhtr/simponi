package com.sipemandu.sipemandu.NFC;
...
public class NFC {
    ...
    public String getNfcId(Intent intent){
        ...
        if (NfcAdapter.ACTION_TAG_DISCOVERED.equals(action)
            ...
            Log.d(TAG,"IDHex"+ toHex(id));
            Log.d(TAG,"IDReversedHex"+ toReversedHex(id));
            Log.d(TAG,"IDDec"+ toDec(id));
            Log.d(TAG,"IDReversedDec"+ toReversedDec(id));
